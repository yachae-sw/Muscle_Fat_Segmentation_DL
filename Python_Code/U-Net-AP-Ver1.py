...
root_path = 'D:/Medical Image processing/AP/Dataset/DICOM/CT Combine/'
...
val_fns_tst = os.listdir(val_dir_tst)  # TEST IMAGE ONLY (의사용)

print(len(train_fns), len(val_fns))

print( len(val_fns_tst)) # TEST IMAGE ONLY (의사용)
